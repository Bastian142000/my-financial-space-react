    ...
    >
      ...
      <div className="flex flex-col gap-20 pt-30 pl-4 text-sm">
        <div className="text-gray-800 transition ease-in-out hover:text-purple-400">
          <Link
            href={"/home"}
            // className={`flex items-center ${pathname === "/home" ? "rounded-l-2xl bg-gradient-to-r from-purple-100 to-purple-400 py-2" : ""}`}
          >
        ...
        <div className="text-gray-800 transition ease-in-out hover:text-purple-400">
          <Link
            ...
            //     ? "rounded-l-2xl bg-gradient-to-r from-purple-100 to-purple-400 py-2"
            //     : ""
            // }`}
          >
